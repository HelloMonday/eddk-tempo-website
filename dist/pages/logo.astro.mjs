import { c as createComponent, r as renderComponent, e as renderScript, a as renderTemplate, m as maybeRenderHead, d as addAttribute } from '../chunks/astro/server_0DCQ29kV.mjs';
import 'piccolore';
import { $ as $$Layout } from '../chunks/Layout_Dj1vS6Bd.mjs';
/* empty css                                */
...
const $$Logo = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Logo Animation", "data-astro-cid-keotgufu": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-keotgufu> <div class="container" data-astro-cid-keotgufu> <h1 data-astro-cid-keotgufu>TEMPO Logo Animation</h1> <div class="logo-wrapper" data-astro-cid-keotgufu> <svg id="logo-svg" viewBox="0 0 333 24" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMid meet" data-astro-cid-keotgufu> <path id="path-t"${addAttribute(normalPaths[0], "d")} fill="white" data-astro-cid-keotgufu></path> <path id="path-e"${addAttribute(normalPaths[1], "d")} fill="white" data-astro-cid-keotgufu></path> <path id="path-m"${addAttribute(normalPaths[2], "d")} fill="white" data-astro-cid-keotgufu></path> <path id="path-p"${addAttribute(normalPaths[3], "d")} fill="white" data-astro-cid-keotgufu></path> <path id="path-o"${addAttribute(normalPaths[4], "d")} fill="white" data-astro-cid-keotgufu></path> </svg> </div> <div class="controls" data-astro-cid-keotgufu> <button id="btn-stretch" data-astro-cid-keotgufu>Stretch</button> <button id="btn-normal" data-astro-cid-keotgufu>Normal</button> <button id="btn-toggle" data-astro-cid-keotgufu>Toggle Loop</button> </div> <p class="hint" data-astro-cid-keotgufu>Click buttons to animate between normal and stretched states</p> <h2 data-astro-cid-keotgufu>Three.js Version</h2> <div id="three-container" data-astro-cid-keotgufu></div> </div> </main> ` })}  ${renderScript($$result, "/Users/serguei/_dev/work/eddk-tempo-website/src/pages/logo.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/serguei/_dev/work/eddk-tempo-website/src/pages/logo.astro", void 0);

const $$file = "/Users/serguei/_dev/work/eddk-tempo-website/src/pages/logo.astro";
const $$url = "/logo";
